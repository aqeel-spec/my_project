    ...
    <div className="relative min-h-[380px] max-w-[1300px]">
      <div className=" px-6 m-auto text-center items-center  justify-items-center ">
        <Image
          ...
          alt="main home img"
          fill
          className=" z-[-1]  relative object-cover  rounded-xl "
        />
        <div className=" mt-[380px] justify-items-center mx-auto  text-center items-center justify-center  ">
          {!dotFilled ? (
            <div onClick={handleFill}>
              {" "}
              <RxDot className=" cursor-pointer h-20 w-20 mx-auto ml-[500px] text-[#978484] text-center mt-[-60px]  absolute" />{" "}
            </div>
          ) : (
            <div onClick={handleFill}>
              <RxDotFilled className=" cursor-pointer h-20 w-20 mx-auto ml-[500px] text-[#978484] text-center mt-[-60px]  absolute" />
            </div>
          )}
          {/* {
